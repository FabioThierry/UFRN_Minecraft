...
execute if score ufrn:subphase_tick ufrn >= ufrn:subphase_tick ufrn run execute positioned -221.03 -17.00 -619.80 if entity @a[tag=XQ0002,r=5,rm=0] run function play/Q0006