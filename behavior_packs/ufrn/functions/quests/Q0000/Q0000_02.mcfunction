...
execute if score ufrn:subphase_tick ufrn matches 305 run execute if block 352 -54 226 iron_door["direction"=1,"open_bit"=false] run setblock 352 -56 226 redstone_torch
