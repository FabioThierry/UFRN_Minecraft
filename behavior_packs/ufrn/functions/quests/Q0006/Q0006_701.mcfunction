...
execute if score ufrn:subphase_tick ufrn >= ufrn:subphase_tick ufrn run execute if block -178.46 -8.00 -525.49 minecraft:lever["lever_direction"="up_east_west","open_bit"=true] run setblock -212.43 -17.00 -610.47 minecraft:redstone_torch



execute if score ufrn:subphase_tick ufrn >= ufrn:subphase_tick ufrn run execute if block -178.46 -8.00 -525.49 minecraft:lever["lever_direction"="up_east_west","open_bit"=false] run setblock -212.43 -17.00 -610.47 minecraft:air
